...
DRIVER3_90_INPUTS = driver3inputs.f90
...
all :  lbfgsb_77_1 lbfgsb_77_2 lbfgsb_77_3 lbfgsb_90_1 lbfgsb_90_2 lbfgsb_90_3 lbfgsb_90_3_INPUTS
...
lbfgsb_90_3_INPUTS : $(DRIVER3_90_INPUTS) $(LBFGSB) $(LINPACK) $(BLAS) $(TIMER)
	$(FC) $(FFLAGS) $(DRIVER3_90_INPUTS) $(LBFGSB) $(LINPACK) $(BLAS) $(TIMER) -o x.lbfgsb_90_3_inputs
